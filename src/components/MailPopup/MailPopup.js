...
class MailPopup extends Component {
  ...
  render() {
    const {
      value, company, category, email, name, contact, message, isLoading, allFieldsValid, allValid,
    } = this.state;
    const {
    ...
    const renderLoaing = isLoading ? <Loading /> : null;

    return (
      <div className={`container--popup${value ? ' popup--open' : ''}`}>
                ...
                <div className="formbox__left">
                  <p className="form__inputbox">
                    <label htmlFor="company">
                      <span>기업명/서비스명*</span>
                      <input
                        placeholder="우리 은하 소속의"
                        aria-describedby="우리 은하 소속의"
                        type="text"
                        name="company"
                  ...
                  <p className="form__selectbox">
                    ...
                    <label htmlFor="category">
                      ...
                      >
                        ...
                        <option value="플루토 리포트">플루토 리포트</option>
